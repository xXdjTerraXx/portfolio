...
export default class Aquarium extends AnimatedObject {
    constructor(sprite_sheet, x_pos, y_pos, app, arrowSpriteSheet, roomEntitiesContainer, desktopContainer, setAquariumFunction){
        ...
        this.setAquariumFunction = setAquariumFunction
        
    }

    // handleClick = () => {
    //     console.log("aquarium gooo")
